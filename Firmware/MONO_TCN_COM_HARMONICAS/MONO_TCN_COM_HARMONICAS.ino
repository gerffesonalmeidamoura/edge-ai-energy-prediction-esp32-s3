...
// ===== Config =====
#define MODEL_NAME  "TCN_MONO_COM_HARMONICAS_INT8"
...
void setup() {
  ...
  resolver.AddShape();               // << necessário no seu modelo
  ...
  // Preenche entrada com “zero lógico” (zp = -105 conforme seu diagnóstico)
