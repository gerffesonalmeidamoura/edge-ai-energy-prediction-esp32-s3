...
// ===== Config =====
#define MODEL_NAME  "MLP_MONO_COM_HARMONICAS"
#define ARENA_SIZE  98304          // ≈96 KB (ajuste fino se necessário)
#define WARMUP      5
#define RUNS        60
#define PIN_PROBE   -1
...
#include "model_data.h"  // mlp_model / mlp_model_len
...
// Watermark para estimar uso real da arena
static size_t arena_used_bytes_est = 0;
static size_t arena_headroom_bytes = 0;
...
void setup() {
  ...
  // Estimativa de arena usada por watermark (varre do fim até achar último byte != 0xA5)
  ...
  // Preenche entrada com zero lógico (zp)
  ...
  switch (phase) {
    ...
    case PH_RUN:
      if (iter < RUNS) {
        ...
        // Linha-resumo de memória (p/ planilha do artigo)
