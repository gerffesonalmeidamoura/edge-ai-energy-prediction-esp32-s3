...
// ===== Config =====
#define MODEL_NAME  "CNN1D_TRI_COM_INTERHARMONICAS_INT8"
...
// ===== Modelo (.h deve definir g_model / g_model_len) =====
...
void setup() {
  ...
  // ===== Resolver para CNN1D INT8 (inclui SHAPE/SLICE/PACK/RESHAPE) =====
  ...
  if (input->type != kTfLiteInt8 || output->type != kTfLiteInt8) {
    Serial.println("ERRO: esperado I/O INT8 para este CNN1D.");
    while (1) delay(1000);
  }
  ...
  // Preenche entrada com zero lógico (zp = -71 do seu diagnóstico)
