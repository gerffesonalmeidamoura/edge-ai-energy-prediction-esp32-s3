...
// ===== Config =====
#define MODEL_NAME  "CNN1D_TRI_SEM_HARMONICAS_INT8"
...
void setup() {
  ...
  // ===== Resolver p/ CNN1D INT8 (inclui SHAPE/SLICE/PACK) =====
  ...
  resolver.AddSoftmax();             // se vier a usar
  ...
  // Preenche entrada com zero lógico (zp = +20 do diagnóstico)
