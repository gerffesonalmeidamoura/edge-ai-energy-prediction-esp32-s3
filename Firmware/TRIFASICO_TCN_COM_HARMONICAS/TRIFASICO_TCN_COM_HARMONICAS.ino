...
// ===== Config =====
#define MODEL_NAME  "TCN_TRI_COM_HARMONICAS_INT8"
#define ARENA_SIZE  196608          // 192 KB (~59 KB tensores => ~182 KB sugeridos + folga)
#define WARMUP      5
#define RUNS        60
#define PIN_PROBE   -1
...
#include "model_data.h"  // const uint8_t tcn_model[]; const int tcn_model_len;
...
void setup() {
  ...
  resolver.AddShape();               // importante neste grafo
  ...
  resolver.AddDequantize();          // opcional
  resolver.AddSoftmax();             // caso seja usado
  ...
  // Preenche entrada com zero lógico (zp ≈ -75 do diagnóstico)
