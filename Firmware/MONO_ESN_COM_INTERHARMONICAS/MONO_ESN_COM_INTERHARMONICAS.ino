...
// ===== Config =====
#define MODEL_NAME  "ESN_MONO_COM_INTERHARMONICAS_INT8"
...
void setup() {
  ...
  // ===== Resolver mínimo para ESN INT8 =====
  // Normalmente: FullyConnected (+ Quantize/Dequantize/Reshape conforme o export).
  static tflite::MicroMutableOpResolver<8> resolver;
  resolver.AddFullyConnected();
  resolver.AddReshape();
  resolver.AddQuantize();
  resolver.AddDequantize();
  // Alguns exports podem usar Add() (bias fusion) ou Logistic/Softmax; manter por segurança:
  resolver.AddAdd();
  ...
  // Preenche entrada com zero lógico (zp = -1 do diagnóstico)
